...
Google is pretty good to recognize a few mistaken clicks but a larger attack should be reported at the official Google contact form[Invalid Clicks Contact Form](https://support.google.com/AdSense/bin/request.py?hl=en&contact_type=invalid_clicks_contact&rd=2 "Invalid Clicks contact form")
