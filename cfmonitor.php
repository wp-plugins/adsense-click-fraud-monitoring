...
define('CFMONITOR_VERSION', '1.8.1'); /*important for the upgrade routine. must be updated to current version*/
...
function cfmonitor_upgrade_db() {
   ...
   if (isset($installed_ver) != CFMONITOR_VERSION) {
		...
		update_option('cfmonitor_checkurl','http://www.google.de/');
    }
}
...
function createtable_clickfraud()
{
	...
	$q1 = "CREATE TABLE ".$tablename." (
        ...
        add_option('cfmonitor_checkurl','http://www.google.de/');
}
