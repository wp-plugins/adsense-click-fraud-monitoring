							...
							<div class="rm_desc"><small>(<?php _e('Count Clicks of a single user since the last n days.'); ?>)
                                                ...
                                                <div class="label">
                                                 ...
                                                 <input name="cfmonitor_email" class="required email" id="cfmonitor_email" type="email" value="<?php if (get_option('cfmonitor_email') == '' || get_option('cfmonitor_email') == null) {echo get_option('admin_email');} else { echo get_option('cfmonitor_email');} ?>" />
                                                    ...
                                                    <div class="rm_desc"><small>(<?php _e('Sent a notification for any blocked IP to this email - <strong>It only works in the PREMIUM  version! Order it via mail at <a href="mailto:admin@x-simulator.de">admin@x-simulator.de</a> for only 10$ and get also fast premium support via e-mail.</strong>'); ?>) </small>
                                                 </div>
                                                 </div>
                                            <div class="rm_input rm_text">
                                                <div class="label">
