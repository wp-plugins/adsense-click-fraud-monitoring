                                                            ...
                                                            <div style="float:clear;">
                                                                    ...
                                                                    if($headers=='200'){
                                                                            if ($html->find('.' . get_option('cfmonitor_customclass')) != null) {
                                                                                ...
                                                                                echo "<h2>No Ads have been found. Check if the class '<strong>" . get_option('cfmonitor_customclass') . "</strong>' can be found in the HTML source of your page. Specify a valid URL for testing in the field bellow:</h2>";
                                                                                }
                                                                            }else {
